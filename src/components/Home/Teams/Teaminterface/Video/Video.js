...
const server_url ="http://localhost:5000/" //please edit this if you are running it in on other port.
			...
			<div>
				{this.state.askForUsername === true ?
					...
					<div>
						...
						<Modal show={this.state.showModal} onHide={this.closeChat} style={{ zIndex: "999999" },{opacity:1}}>
							<Modal.Header closeButton>
								<Modal.Title>Chat Room</Modal.Title>
							</Modal.Header>
							<Modal.Body style={{ overflow: "auto", overflowY: "auto", height: "400px", textAlign: "left",fontSize:"15px" }} >
